...
public partial class SchoolMangementSystemContext : DbContext
{
	public SchoolMangementSystemContext()
	{
	}

	public SchoolMangementSystemContext(DbContextOptions<SchoolMangementSystemContext> options)
		: base(options)
	{
	...
	protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
	{
		...
		// Ensure this is called in case options are configured here
		//ChangeTracker.LazyLoadingEnabled = false;
        //optionsBuilder.UseSqlServer("Data Source=DESKTOP-L9I46P8;uid=sa;pwd=sql2014;Initial Catalog=SchoolMangementSystem;TrustServerCertificate=true;persist security info=True; Integrated Security=SSPI;");
        optionsBuilder.UseSqlServer("Data Source=DESKTOP-GDN6AI3\\SQL2014;uid=sa;pwd=sql2014;Initial Catalog=SchoolMangementSystem;TrustServerCertificate=true;persist security info=True; Integrated Security=SSPI;");
    }
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		modelBuilder.Entity<AssesmentMaster>(entity =>
		{
			...
			entity.Property(e => e.AssesmentIsActive).HasColumnName("ASSESMENT_IS_ACTIVE");
		...
		modelBuilder.Entity<AttendanceReasonMaster>(entity =>
		{
			...
			entity.Property(e => e.AttendReasonIsActive).HasColumnName("ATTEND_REASON_IS_ACTIVE");
		...
		modelBuilder.Entity<AuthorMaster>(entity =>
		{
			...
			entity.Property(e => e.AuthorIsActive).HasColumnName("AUTHOR_IS_ACTIVE");
		...
		modelBuilder.Entity<BillDetail>(entity =>
		{
			...
			entity.HasOne(d => d.BillDetailBill).WithMany(p => p.BillDetails)
				.HasForeignKey(d => d.BillDetailBillId)
		...
		modelBuilder.Entity<BookCategoryMaster>(entity =>
		{
			...
			entity.Property(e => e.BookCatIsActive).HasColumnName("BOOK_CAT_IS_ACTIVE");
		...
		modelBuilder.Entity<BookMaster>(entity =>
		{
			...
			entity.Property(e => e.BookIsActive).HasColumnName("BOOK_IS_ACTIVE");
		...
		modelBuilder.Entity<BookTransactionDetail>(entity =>
		{
			...
			entity.Property(e => e.BookTransIsActive).HasColumnName("BOOK_TRANS_IS_ACTIVE");
		...
		modelBuilder.Entity<BookTypeMaster>(entity =>
		{
			...
			entity.Property(e => e.BookTypeIsActive).HasColumnName("BOOK_TYPE_IS_ACTIVE");
		...
		modelBuilder.Entity<CategoryMaster>(entity =>
		{
			...
			entity.Property(e => e.CatIsActive).HasColumnName("CAT_IS_ACTIVE");
		...
		modelBuilder.Entity<ClassMaster>(entity =>
		{
			...
			entity.Property(e => e.CmIsActive).HasColumnName("CM_IS_ACTIVE");
		...
		modelBuilder.Entity<CompanyMaster>(entity =>
		{
			...
			entity.Property(e => e.CmpIsActive).HasColumnName("CMP_IS_ACTIVE");
		...
		modelBuilder.Entity<DeptDesigDetail>(entity =>
		{
			...
			entity.Property(e => e.DepdesIsActive).HasColumnName("DEPDES_IS_ACTIVE");
		...
		modelBuilder.Entity<DeptMaster>(entity =>
		{
			...
			entity.Property(e => e.DeptIsActive).HasColumnName("DEPT_IS_ACTIVE");
		...
		modelBuilder.Entity<DesigGradeDetail>(entity =>
		{
			...
			entity.Property(e => e.DesgradeIsActive).HasColumnName("DESGRADE_IS_ACTIVE");
		...
		modelBuilder.Entity<DesigMaster>(entity =>
		{
			...
			entity.Property(e => e.DesigIsActive).HasColumnName("DESIG_IS_ACTIVE");
		...
		modelBuilder.Entity<EmpCategoryMaster>(entity =>
		{
			...
			entity.Property(e => e.EmpCatIsActive).HasColumnName("EMP_CAT_IS_ACTIVE");
		...
		modelBuilder.Entity<EmpSalaryStructureDetail>(entity =>
		{
			...
			entity.Property(e => e.EssdIsActive).HasColumnName("ESSD_IS_ACTIVE");
		...
		modelBuilder.Entity<EmpTypeMaster>(entity =>
		{
			...
			entity.Property(e => e.EmpTypeIsActive).HasColumnName("EMP_TYPE_IS_ACTIVE");
		...
		modelBuilder.Entity<ExpenseCategoryMaster>(entity =>
		{
			...
			entity.Property(e => e.ExpCatIsActive).HasColumnName("EXP_CAT_IS_ACTIVE");
		...
		modelBuilder.Entity<FeeClassDetail>(entity =>
		{
			...
			entity.Property(e => e.FcdIsActive).HasColumnName("FCD_IS_ACTIVE");
		...
		modelBuilder.Entity<FeeClassDetailsHistory>(entity =>
		{
			...
			entity.Property(e => e.FcdhIsActive).HasColumnName("FCDH_IS_ACTIVE");
		...
		modelBuilder.Entity<FeesCategoryMaster>(entity =>
		{
			...
			entity.Property(e => e.FcmCatIsActive).HasColumnName("FCM_CAT_IS_ACTIVE");
		...
		modelBuilder.Entity<FeesDiscountCategoryMaster>(entity =>
		{
			...
			entity.Property(e => e.FdcmIsActive).HasColumnName("FDCM_IS_ACTIVE");
		...
		modelBuilder.Entity<GradeMaster>(entity =>
		{
			...
			entity.Property(e => e.GradeIsActive).HasColumnName("GRADE_IS_ACTIVE");
		...
		modelBuilder.Entity<HolidayMaster>(entity =>
		{
			...
			entity.Property(e => e.HolidayIsActive).HasColumnName("HOLIDAY_IS_ACTIVE");
		...
		modelBuilder.Entity<HolidayTypeMaster>(entity =>
		{
			...
			entity.Property(e => e.HolidayTypeIsActive).HasColumnName("HOLIDAY_TYPE_IS_ACTIVE");
		...
		modelBuilder.Entity<InventoryMaster>(entity =>
		{
			...
			entity.Property(e => e.InvIsActive).HasColumnName("INV_IS_ACTIVE");
		...
		modelBuilder.Entity<ItemLocationMaster>(entity =>
		{
			...
			entity.Property(e => e.ItemLocationIsActive).HasColumnName("ITEM_LOCATION_IS_ACTIVE");
		...
		modelBuilder.Entity<ItemMaster>(entity =>
		{
			...
			entity.Property(e => e.ItemIsActive).HasColumnName("ITEM_IS_ACTIVE");
		...
		modelBuilder.Entity<ItemTypeMaster>(entity =>
		{
			...
			entity.Property(e => e.ItemTypeIsActive).HasColumnName("ITEM_TYPE_IS_ACTIVE");
		...
		modelBuilder.Entity<LeaveStatusMaster>(entity =>
		{
			...
			entity.Property(e => e.LeaveStatusIsActive).HasColumnName("LEAVE_STATUS_IS_ACTIVE");
		...
		modelBuilder.Entity<LeaveTypeMaster>(entity =>
		{
			...
			entity.Property(e => e.LeaveTypeIsActive).HasColumnName("LEAVE_TYPE_IS_ACTIVE");
		...
		modelBuilder.Entity<LocationMaster>(entity =>
		{
			...
			entity.Property(e => e.LocIsActive).HasColumnName("LOC_IS_ACTIVE");
		...
		modelBuilder.Entity<MarksGradeMaster>(entity =>
		{
			...
			entity.Property(e => e.MarksGradeIsActive).HasColumnName("MARKS_GRADE_IS_ACTIVE");
		...
		modelBuilder.Entity<PaymentModeMaster>(entity =>
		{
			...
			entity.Property(e => e.PaymentModeIsActive).HasColumnName("PAYMENT_MODE_IS_ACTIVE");
		...
		{
			entity.HasKey(e => e.Id).HasName("PK__Privileg__3214EC073470F0F0");
		...
		modelBuilder.Entity<ProfessionMaster>(entity =>
		{
			...
			entity.Property(e => e.ModifiedDate)
				.HasColumnType("datetime")
				.HasColumnName("MODIFIED_DATE");
			entity.Property(e => e.ProfIsActive).HasColumnName("PROF_IS_ACTIVE");
		...
		modelBuilder.Entity<QualificationMaster>(entity =>
		{
			...
			entity.Property(e => e.ModifiedDate)
				.HasColumnType("datetime")
				.HasColumnName("MODIFIED_DATE");
			entity.Property(e => e.QualIsActive).HasColumnName("QUAL_IS_ACTIVE");
		...
		modelBuilder.Entity<RoleMaster>(entity =>
		{
			...
			entity.Property(e => e.RoleIsActive).HasColumnName("ROLE_IS_ACTIVE");
		...
		{
			entity.HasKey(e => e.Id).HasName("PK__RolePriv__3214EC071B59E7D4");
			...
			entity.HasOne(d => d.Privilege).WithMany(p => p.RolePrivileges)
				...
				.OnDelete(DeleteBehavior.ClientSetNull)
				.HasConstraintName("FK__RolePrivi__Privi__25FB978D");
		...
		modelBuilder.Entity<RouteDetail>(entity =>
		{
			...
			entity.Property(e => e.RouteDetailsIsActive).HasColumnName("ROUTE_DETAILS_IS_ACTIVE");
		...
		modelBuilder.Entity<RouteMaster>(entity =>
		{
			...
			entity.Property(e => e.RouteIsActive).HasColumnName("ROUTE_IS_ACTIVE");
		...
		modelBuilder.Entity<RouteStopDetail>(entity =>
		{
			...
			entity.Property(e => e.RouteStopIsActive).HasColumnName("ROUTE_STOP_IS_ACTIVE");
		...
		modelBuilder.Entity<SalaryDesigGradeDetailsHistory>(entity =>
		{
			...
			entity.Property(e => e.SaldgdhIsActive).HasColumnName("SALDGDH_IS_ACTIVE");
		...
		modelBuilder.Entity<SalaryHeadMaster>(entity =>
		{
			...
			entity.Property(e => e.SalhmIsActive).HasColumnName("SALHM_IS_ACTIVE");
		...
		modelBuilder.Entity<SchoolContactMaster>(entity =>
		{
			...
			entity.Property(e => e.SconmIsActive).HasColumnName("SCONM_IS_ACTIVE");
		...
		modelBuilder.Entity<SchoolMaster>(entity =>
		{
			...
			entity.Property(e => e.SchIsActive).HasColumnName("SCH_IS_ACTIVE");
		...
		modelBuilder.Entity<SectionMaster>(entity =>
		{
			...
			entity.Property(e => e.SmIsActive).HasColumnName("SM_IS_ACTIVE");
		...
		modelBuilder.Entity<SessionMaster>(entity =>
		{
			...
			entity.Property(e => e.SessionIsActive).HasColumnName("SESSION_IS_ACTIVE");
		...
		modelBuilder.Entity<Smstask>(entity =>
		{
			...
			entity.Property(e => e.StsIsActive).HasColumnName("STS_IS_ACTIVE");
		...
		modelBuilder.Entity<SmstaskSmtpDetail>(entity =>
		{
			...
			entity.Property(e => e.StssmtpDetailIsActive).HasColumnName("STSSMTP_DETAIL_IS_ACTIVE");
		...
		modelBuilder.Entity<SmtpDetail>(entity =>
		{
			...
			entity.Property(e => e.SmtpDetailIsActive).HasColumnName("SMTP_DETAIL_IS_ACTIVE");
		...
		modelBuilder.Entity<StateMaster>(entity =>
		{
			...
			entity.HasOne(d => d.StateCountry).WithMany(p => p.StateMasters)
				.HasForeignKey(d => d.StateCountryId)
				.HasConstraintName("FK__StateMast__STATE__26EFBBC6");
		});
		...
		modelBuilder.Entity<StudentCommentDetail>(entity =>
		{
			...
			entity.Property(e => e.StucommentIsAactive).HasColumnName("STUCOMMENT_IS_AACTIVE");
		...
		modelBuilder.Entity<StudentCommentDetailsHistory>(entity =>
		{
			...
			entity.Property(e => e.StucommenthIsAactive).HasColumnName("STUCOMMENTH_IS_AACTIVE");
		...
		modelBuilder.Entity<StudentFeeDetail>(entity =>
		{
			...
			entity.Property(e => e.StudfeeId).HasColumnName("STUDFEE_ID");
			entity.Property(e => e.CreatedBy)
				.HasMaxLength(50)
				.IsUnicode(false)
				.HasDefaultValue("SuperAdmin")
			...
			entity.Property(e => e.StudFeesPaid).HasColumnName("STUD_FEES_PAID");
			entity.Property(e => e.StudLateFeeAmount)
				.HasColumnType("decimal(18, 2)")
				.HasColumnName("STUD_LATE_FEE_AMOUNT");
			entity.Property(e => e.StudSchId).HasColumnName("STUD_SCH_ID");
			entity.Property(e => e.StudfeeCmId).HasColumnName("STUDFEE_CM_ID");
			entity.Property(e => e.StudfeeSecId).HasColumnName("STUDFEE_SEC_ID");
			entity.Property(e => e.StudfeeStuGuid).HasColumnName("STUDFEE_STU_GUID");
		});
		...
		modelBuilder.Entity<StudentFeeDetailsHistory>(entity =>
		{
			...
			entity.Property(e => e.StudfeehId).HasColumnName("STUDFEEH_ID");
			entity.Property(e => e.CreatedBy)
				.HasMaxLength(50)
				.IsUnicode(false)
				.HasDefaultValue("SuperAdmin")
			...
			entity.Property(e => e.StudSchId).HasColumnName("STUD_SCH_ID");
			entity.Property(e => e.StudfeehCmId).HasColumnName("STUDFEEH_CM_ID");
			entity.Property(e => e.StudfeehSecId).HasColumnName("STUDFEEH_SEC_ID");
			entity.Property(e => e.StudfeehStuGuid).HasColumnName("STUDFEEH_STU_GUID");

			entity.HasOne(d => d.StudfeehCm).WithMany(p => p.StudentFeeDetailsHistories)
				.HasForeignKey(d => d.StudfeehCmId)
				.OnDelete(DeleteBehavior.ClientSetNull)
				.HasConstraintName("FK_StudentFeeDetailsHistory_ClassMaster");

			entity.HasOne(d => d.StudfeehStu).WithMany(p => p.StudentFeeDetailsHistories)
				.HasForeignKey(d => d.StudfeehStuGuid)
				.OnDelete(DeleteBehavior.ClientSetNull)
				.HasConstraintName("FK_StudentFeeDetailsHistory_StudentMaster");
		});
		...
		modelBuilder.Entity<StudentGradeDetail>(entity =>
		{
			...
			entity.Property(e => e.StugradeIsActive).HasColumnName("STUGRADE_IS_ACTIVE");
		...
		modelBuilder.Entity<StudentGradeDetailsHistory>(entity =>
		{
			...
			entity.Property(e => e.StugradehIsActive).HasColumnName("STUGRADEH_IS_ACTIVE");
		...
		modelBuilder.Entity<StudentMarksDetail>(entity =>
		{
			...
			entity.Property(e => e.StumarksIsActive).HasColumnName("STUMARKS_IS_ACTIVE");
		...
		modelBuilder.Entity<StudentMarksDetailsHistory>(entity =>
		{
			...
			entity.Property(e => e.StumarkshIsActive).HasColumnName("STUMARKSH_IS_ACTIVE");
		...
		modelBuilder.Entity<SupplierMaster>(entity =>
		{
			...
			entity.Property(e => e.SupplierIsActive).HasColumnName("SUPPLIER_IS_ACTIVE");
		...
		modelBuilder.Entity<TeacherClassDetail>(entity =>
		{
			...
			entity.Property(e => e.TcdIsActive).HasColumnName("TCD_IS_ACTIVE");
		...
		modelBuilder.Entity<VehicleMaster>(entity =>
		{
			...
			entity.Property(e => e.VehIsActive).HasColumnName("VEH_IS_ACTIVE");
		...
		modelBuilder.Entity<VendorMaster>(entity =>
		{
			...
			entity.Property(e => e.VendorIsActive).HasColumnName("VENDOR_IS_ACTIVE");
		...
		modelBuilder.Entity<VisitorMaster>(entity =>
		{
			...
			entity.Property(e => e.VmIsActive).HasColumnName("VM_IS_ACTIVE");
		...
		modelBuilder.Entity<VoucherMaster>(entity =>
		{
			...
			entity.Property(e => e.VoucherIsActive).HasColumnName("VOUCHER_IS_ACTIVE");
